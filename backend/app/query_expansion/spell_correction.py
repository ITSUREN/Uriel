...
class SpellCorrector:
    ...
    def _ensure_index(self, index_repo: IndexRepository) -> None:
        ...
        if self._shinge_index.is_stale(current_size):
            self._shinge_index.build(index_repo.get_vocabulary())
    ...
    def _best_match(self, word: str) -> str | None:
        candidates = self._shinge_index.candidates(word, max_candidates=self.max_candidates)
